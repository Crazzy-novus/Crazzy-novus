...
//                Statement statement = connection.createStatement();
                String sqlQuery = "INSERT INTO `user`(`name`, `username`, `emailid`, `phonenumber`, `password`) VALUES (?, ?, ?, ?, ?)";
                ...
                JOptionPane.showMessageDialog(this,"User is successfully created","Success",JOptionPane.INFORMATION_MESSAGE);
                connection.close();
            }catch(Exception e){
                JFrame frame = new JFrame();
                System.out.println(e.getMessage());
                JOptionPane.showMessageDialog(this,"Unable to create new user","Error",JOptionPane.ERROR_MESSAGE);
            }
